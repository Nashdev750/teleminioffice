...
// input-data routing 
const AddCalendarDay = Loadable(lazy(() => import('views/input-data/calendar/add')));
const AddSchool = Loadable(lazy(() => import('views/input-data/School/add')));
const SchoolList = Loadable(lazy(() => import('views/input-data/School/view')));
const SchoolDetail = Loadable(lazy(() => import('views/input-data/School/details')));
const AddSchoolMenu = Loadable(lazy(() => import('views/input-data/schoolMenu/add')));
const SchoolMenuList = Loadable(lazy(() => import('views/input-data/schoolMenu/view')));
const SchoolMenuItem = Loadable(lazy(() => import('views/input-data/schoolMenu/item')));
const AddTruck = Loadable(lazy(() => import('views/input-data/trucks/add')));
const TruckList = Loadable(lazy(() => import('views/input-data/trucks/view')));
const SchoolOrderList = Loadable(lazy(() => import('views/input-data/order-list/view')));
const MonthlyOrderDetail = Loadable(lazy(() => import('views/input-data/order-list/details')));
const CreateOrderDetail = Loadable(lazy(() => import('views/input-data/order-list/add')));
const Warehouse = Loadable(lazy(() => import('views/input-data/warehouse')));
const WarehouseLevel = Loadable(lazy(() => import('views/input-data/warehouse/StockLevel')));
const DeliveryManagement  = Loadable(lazy(() => import('views/input-data/deliveryManagement/index')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/input-data/add-school',
            element: <AddSchool />
        },
        {
            path: '/input-data/schools',
            element: <SchoolList />
        },
        {
            path: '/input-data/school-detail',
            element: <SchoolDetail />
        },
        {
            path: '/input-data/add-schoolmenu',
            element: <AddSchoolMenu />
        },
        {
            path: '/input-data/menu-items',
            element: <SchoolMenuItem />
        },
        {
            path: '/input-data/schoolmenu',
            element: <SchoolMenuList />
        },
        {
            path: '/input-data/add-truck',
            element: <AddTruck />
        },
        {
            path: '/input-data/trucks',
            element: <TruckList />
        },
        {
            path: '/input-data/monthly-order-list',
            element: <SchoolOrderList />
        },
        {
            path: '/input-data/month-order-detail',
            element: <MonthlyOrderDetail />
        },
        {
            path: '/input-data/create-order-detail',
            element: <CreateOrderDetail />
        },
        {
            path: '/input-data/stock-level',
            element: <WarehouseLevel />
        } ,
        {
            path: '/input-data/delivery-management',
