...
// material-ui
import { Button, ButtonGroup, Grid, IconButton, Stack, Tooltip, Typography, useMediaQuery, Alert } from '@mui/material';
...
const Toolbar = ({ date, view, days, onClickNext, onClickPrev, onClickToday, onChangeView, ...others }) => {
    ...
    return (
        <>
            ...
            <Grid item xs={12}>
                <Grid item xs={12} >
                    <Alert variant="filled" severity="success" sx={{ m: 0.5 }}>
                        Feeding days {days}
                    </Alert>
                </Grid>
            </Grid>
