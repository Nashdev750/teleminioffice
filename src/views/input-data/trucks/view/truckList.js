...
export default function TruckList() {
    ...
    const handleSearch = (event) => {
        ...
        if (newString) {
            const newRows = trucks.filter((row) => {
                let matches = true;

                const properties = ['make', 'reg_number'];
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{row.reg_number}</TableCell>
                                        <TableCell align="center">{row.capacity}</TableCell>
                                        <TableCell align="center">{row.volume}</TableCell>
                                        <TableCell align="center">
                                            {row.available === true && <Chip label="Available" size="small" chipcolor="success" />}
                                            {row.available === false && <Chip label="Not Available" size="small" chipcolor="error" />}
                                        </TableCell>
